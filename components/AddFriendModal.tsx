        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <p className="text-sm text-slate-400">Enter the Operator ID of the user you wish to add to your trusted network.</p>
                    
                    <div>
                        <label htmlFor="operator-id" className="block text-xs font-medium text-slate-300 mb-1">
                            Operator ID
                        </label>
                        <input
                            id="operator-id"
                            ...
                            className="w-full bg-slate-800 border border-slate-600 rounded-md p-2 text-slate-100 font-mono focus:ring-2 focus:ring-cyan-500"
                            placeholder="e.g., OP_7B3A9C1D..."
                            required
                        />
                    </div>
