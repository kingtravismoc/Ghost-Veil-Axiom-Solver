...
import { PlayIcon, StopIcon, ShieldIcon, ZapIcon, GhostIcon } from './icons';
...
const SdrDevilControl: React.FC<SdrDevilControlProps> = (props) => {
    ...
    return (
        <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-700 quantum-shield space-y-6">
            ...
            {/* Monitoring Section */}
            <div className="space-y-3 p-4 border border-slate-600 rounded-lg bg-slate-900/30">
